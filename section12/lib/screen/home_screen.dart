...
import 'package:section12/screen/settings_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void onRandomNumberGenerate() {
    ...
    while (newNumbers.length != 3) {
      final number = rand.nextInt(maxNumber); // 1000 보다 작은 랜덤 값
  ...
  void onSettingsPop() async {
    // result 값은 나중에 pop하였을 때 돌려 받을 미래의 값이므로 async와 await를 통해 비동기 처리를 해준다
    // of는 가장 가까운 context를 가져옴
